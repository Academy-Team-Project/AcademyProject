			...
			<table width="80%" height="80%" cellspacing="0" border="0" cellpadding="10" class="notice_table"> 
				<tr>
					<td align="center" bgcolor="#FFFFFF">  
						<h2>질문게시판 작성</h2> <br><br>
							<table width="85%" height="70%" border="0" cellspacing="0" cellpadding="5"> <!-- width 값으로 크기 고정 -->
								<form action="question_writeOk"  method="post" name="question_write_form">
									...
									<tr>
										...
										<td class="">
											<input class="input_box" type="text" name="questiontitle">
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<textarea class="text_area" rows="20" cols="50" name="questioncontent"></textarea>
										</td>
									</tr>
									
									<tr>
										<td colspan="2" align="right">
											<input class="button" type="button" value="등록" onclick="questionCheck()">&nbsp;
											<input class="button" type="button" value="취소" onclick="location.href='/question/question_list'">
										</td>
									</tr>
								</form>
							</table>
