			...
			<table width="80%" height="80%" cellspacing="0" border="0" cellpadding="10" class="notice_table"> 
				<tr>
					<td align="center" bgcolor="#FFFFFF">  
						<h2>공지사항 수정 완료</h2> <br><br>
							<table width="85%" height="70%" border="0" cellspacing="0" cellpadding="5"> <!-- width 값으로 크기 고정 -->
								<form action="/notice/notice_list"  method="post" name="notice_write_form">
									<input type="hidden" name="noticenum" value="${noticeBoardDto.noticenum }"> <!-- 화면에는 숨긴 값 -->
									
									<tr>
										<td class="notice_title" width="20%" align="left">ID : </td>
										<td class="">
											<input class="input_box" type="text" name="memberid" size="50" value="${noticeBoardDto.memberid }" readonly="readonly">
										</td>
									</tr>
									...
									<tr>
										...
										<td class="">
											<input class="input_box" type="text" name="membername" size="50" value="${noticeBoardDto.membername }" readonly="readonly">
										</td>
									</tr>
									...
									<tr>
										...
										<td class="">
											<input class="input_box" type="text" name="noticetitle" size="100" value="${noticeBoardDto.noticetitle }" readonly="readonly">
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<textarea class="text_area" rows="30" cols="150" name="noticecontent" readonly="readonly">${noticeBoardDto.noticecontent }</textarea>
										</td>
									</tr>
